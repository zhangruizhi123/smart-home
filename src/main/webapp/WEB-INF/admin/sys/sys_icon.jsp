                ...
                <form action="" class="userForm form-horizontal">
	                <div class="box-body">
	                	...
	                	<div class="form-group">
		                  ...
		                  <div class="col-sm-10">
		                    <input name="name" type="text" class="form-control" placeholder="请输入图标名称">
		                  </div>
		                </div>
	                </div>
                </form>
...
$(function () {
    ...
    $("#add").click(function(){
    	$("#addUser").modal('show');
    	$(".userForm")[0].reset();
    	$(".userForm")[0].action="<%=path%>/sysIcon/insertSeletive.do";
    });
    	...
    	$.confirm({
            ...
            callback: function(result) {
                if(result) {
	            	var id= row.id;
	            	$.ajax({
	            		url:'<%=path%>/sysIcon/deleteByPrimaryKey.do',
	            		type:'post',
	            		dataType:'json',
	            		data:{id:id},
    ...
    $("#edit").click(function(){
    	...
    	//设备表单的action
    	$(".userForm")[0].action="<%=path%>/sysIcon/updateByPrimaryKey.do";
    	$(".userForm")[0].reset();
